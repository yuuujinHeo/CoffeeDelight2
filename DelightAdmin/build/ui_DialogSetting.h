...
public:
    ...
    QPushButton *BTN_ERROR_CLEAR_HOT_1;
    QLineEdit *LE_DEVICE_ERROR_PET_CUP_2;
    QLineEdit *LE_DEVICE_ERROR_HOT_1;
    QLabel *label_155;
    QLineEdit *LE_DEVICE_ERROR_SODA_1;
    QLineEdit *LE_DEVICE_ERROR_PAPER_CUP_1;
    QLabel *label_152;
    QLabel *label_154;
    QPushButton *BTN_ERROR_CLEAR_PET_CUP_1;
    QPushButton *BTN_ERROR_CLEAR_HOT_2;
    QLineEdit *LE_DEVICE_ERROR_HOT_2;
    QLabel *label_153;
    QLabel *label_158;
    QPushButton *BTN_ERROR_CLEAR_PAPER_CUP_2;
    QPushButton *BTN_ERROR_CLEAR_SODA_1;
    ...
    QLabel *label_159;
    QLineEdit *LE_DEVICE_ERROR_SODA_2;
    QPushButton *BTN_ERROR_CLEAR_SODA_2;
...
""));
        ...
        layoutWidget->setGeometry(QRect(60, 40, 251, 370));
        ...
        BTN_ERROR_CLEAR_HOT_1 = new QPushButton(layoutWidget);
        BTN_ERROR_CLEAR_HOT_1->setObjectName(QString::fromUtf8("BTN_ERROR_CLEAR_HOT_1"));

        gridLayout->addWidget(BTN_ERROR_CLEAR_HOT_1, 7, 2, 1, 1);
        ...
        LE_DEVICE_ERROR_HOT_1 = new QLineEdit(layoutWidget);
        LE_DEVICE_ERROR_HOT_1->setObjectName(QString::fromUtf8("LE_DEVICE_ERROR_HOT_1"));
        LE_DEVICE_ERROR_HOT_1->setFont(font1);
        LE_DEVICE_ERROR_HOT_1->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        LE_DEVICE_ERROR_HOT_1->setReadOnly(true);

        gridLayout->addWidget(LE_DEVICE_ERROR_HOT_1, 7, 1, 1, 1);
        ...
        LE_DEVICE_ERROR_SODA_1 = new QLineEdit(layoutWidget);
        LE_DEVICE_ERROR_SODA_1->setObjectName(QString::fromUtf8("LE_DEVICE_ERROR_SODA_1"));
        LE_DEVICE_ERROR_SODA_1->setFont(font1);
        LE_DEVICE_ERROR_SODA_1->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        LE_DEVICE_ERROR_SODA_1->setReadOnly(true);

        gridLayout->addWidget(LE_DEVICE_ERROR_SODA_1, 9, 1, 1, 1);
        ...
        BTN_ERROR_CLEAR_HOT_2 = new QPushButton(layoutWidget);
        BTN_ERROR_CLEAR_HOT_2->setObjectName(QString::fromUtf8("BTN_ERROR_CLEAR_HOT_2"));

        gridLayout->addWidget(BTN_ERROR_CLEAR_HOT_2, 8, 2, 1, 1);

        LE_DEVICE_ERROR_HOT_2 = new QLineEdit(layoutWidget);
        LE_DEVICE_ERROR_HOT_2->setObjectName(QString::fromUtf8("LE_DEVICE_ERROR_HOT_2"));
        LE_DEVICE_ERROR_HOT_2->setFont(font1);
        LE_DEVICE_ERROR_HOT_2->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        LE_DEVICE_ERROR_HOT_2->setReadOnly(true);

        gridLayout->addWidget(LE_DEVICE_ERROR_HOT_2, 8, 1, 1, 1);
        ...
        gridLayout->addWidget(label_158, 8, 0, 1, 1);
        ...
        BTN_ERROR_CLEAR_SODA_1 = new QPushButton(layoutWidget);
        BTN_ERROR_CLEAR_SODA_1->setObjectName(QString::fromUtf8("BTN_ERROR_CLEAR_SODA_1"));

        gridLayout->addWidget(BTN_ERROR_CLEAR_SODA_1, 9, 2, 1, 1);
        ...
        gridLayout->addWidget(label_157, 9, 0, 1, 1);
        ...
        gridLayout->addWidget(label_159, 10, 0, 1, 1);

        LE_DEVICE_ERROR_SODA_2 = new QLineEdit(layoutWidget);
        LE_DEVICE_ERROR_SODA_2->setObjectName(QString::fromUtf8("LE_DEVICE_ERROR_SODA_2"));
        LE_DEVICE_ERROR_SODA_2->setFont(font1);
        LE_DEVICE_ERROR_SODA_2->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        LE_DEVICE_ERROR_SODA_2->setReadOnly(true);

        gridLayout->addWidget(LE_DEVICE_ERROR_SODA_2, 10, 1, 1, 1);

        BTN_ERROR_CLEAR_SODA_2 = new QPushButton(layoutWidget);
        BTN_ERROR_CLEAR_SODA_2->setObjectName(QString::fromUtf8("BTN_ERROR_CLEAR_SODA_2"));

        gridLayout->addWidget(BTN_ERROR_CLEAR_SODA_2, 10, 2, 1, 1);
